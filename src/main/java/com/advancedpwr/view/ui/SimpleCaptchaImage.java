 ...
 */
public class SimpleCaptchaImage  
{

    public static final int MAX_LETTER_COUNT = 6;
    public static final int LETTER_WIDTH = 33;
    public static final int IMAGE_HEIGHT = 40;
    public static final double SKEW = 0.5;
    public static final int DRAW_LINES = 3;
    public static final int DRAW_BOXES = 300;
    public static final int MAX_X = LETTER_WIDTH * MAX_LETTER_COUNT;
    public static final int MAX_Y = IMAGE_HEIGHT;
    ...
    public BufferedImage skewImage(String securityChars) {
        ...
        for (int i = 0; i < securityChars.length(); i++) {
            double angle = 0;
            if (Math.random() * 2 > 1) {
